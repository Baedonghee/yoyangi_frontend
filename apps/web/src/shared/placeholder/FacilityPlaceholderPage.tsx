...
type FacilityPlaceholderPageProps = {
  id: string;
};

export function FacilityPlaceholderPage({
  id
}: FacilityPlaceholderPageProps) {
  return (
    <>
      <Head>
        <title>{`시설 상세 ${id} | ${siteConfig.name}`}</title>
        <meta
          name="description"
          content="추천시설 상세 페이지는 이후 서버 응답 스펙에 맞춰 연결될 예정입니다."
        />
      </Head>
        ...
        <section className={styles.stage}>
          <div className={styles.heroCard}>
            <div className={styles.copy}>
              ...
              <h1>시설 상세 {id}</h1>
              <p>
                추천시설 상세 페이지는 갤러리, 시설 소개, 제공 서비스, 상담
                CTA를 한 화면에 담는 구조로 들어갈 예정입니다.
              </p>
            ...
            <div className={styles.previewPanel}>
              <div className={styles.previewHead}>
                <strong>
                  상단 갤러리와 핵심 정보, 하단 서비스 블록을 넣는 상세형
                  샘플입니다.
                </strong>
              ...
              <div className={styles.previewGrid}>
                <article className={styles.previewCard}>
                  ...
                  <p>
                    첫 화면에서 시설 분위기를 알 수 있도록 상단 대형 이미지와
                    썸네일 묶음을 둡니다.
                  </p>
                </article>
                <article className={styles.previewCard}>
                  ...
                  <h2>위치, 평점, 서비스 태그</h2>
                  <p>
                    주소, 전화번호, 시설 유형, 주요 서비스 태그를 핵심 정보
                    영역에 정리합니다.
                  </p>
                </article>
                <article className={styles.previewCard}>
                  ...
                  <h2>상담 신청과 비교 저장</h2>
                  <p>
                    바로 상담하기, 찜하기, 비교하기 같은 전환 버튼을 우측에
                    배치합니다.
                  </p>
                </article>
              </div>
